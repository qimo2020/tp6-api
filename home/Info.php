...
class Info extends Base
{
    ...
    public function getSign()
    {
        ...
        try {
            ...
            $obj = new \app\api\lib\ApiToken([], $appInfo);
            if (!$info = $obj->getToken()) {
                $info = $obj->tokenCreate();
            }
            $sign = \hi\Sign::getSign($params, $info['token'], true);
    ...
    public function getToken()
    {
        ...
        try {
            ...
            $token = md5($token . $headers['timestamp'] . $headers['rand']);
